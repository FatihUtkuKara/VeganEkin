...
//geldi
            ...
            rv3.layoutManager = StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL)
                ...
                val savethenatureburger =
                    LastVeganProduct("savethenatureburger", 31, "savethenatureburger")
                val savethenaturekebap =
                    LastVeganProduct("savethenaturekebap", 32, "savethenaturekebap")
                val superfreshbezelye =
                    LastVeganProduct("superfreshbezelye", 33, "superfreshbezelye")
                val superfreshfalafel =
                    LastVeganProduct("superfreshfalafel", 34, "superfreshfalafel")
                val superfreshgarnit = LastVeganProduct("superfreshgarnit", 35, "superfreshgarnit")
                val superfreshispanak =
                    LastVeganProduct("superfreshispanak", 36, "superfreshispanak")
                val superfreshmilfoy = LastVeganProduct("superfreshmilfoy", 37, "superfreshmilfoy")
                val superfreshpatates =
                    LastVeganProduct("superfreshpatates", 38, "superfreshpatates")
                val superfreshpatates2 =
                    LastVeganProduct("superfreshpatates2", 39, "superfreshpatates2")
